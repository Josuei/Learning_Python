...
def get_profits(chainmap):
    ...
    for key in chainmap.keys():
        if 'holiday_profit' in key:
            holidays_profits += chainmap[key]
        else:
            standard_profits += chainmap[key]
    return standard_profits, holidays_profits
...
print(current_year_standard_profit)
print(current_year_holiday_profit)
