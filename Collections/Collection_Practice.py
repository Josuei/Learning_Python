...
print(split_prices)
# Task 3: Create a namedtuple called "ClothesBundle"
ClothesBundle = namedtuple('ClothesBundle', ['bundle_items', 'bundle_price'])
# Task 4: Create a list of ClothesBundle objects
bundles = []
while len(split_prices) >= 5:
    ...
    bundle_price = sum(item[1] for item in bundle_list)
    bundles.append(ClothesBundle(bundle_list, bundle_price))
print(bundles)
#Task 5: Sort the bundles by price over 100
